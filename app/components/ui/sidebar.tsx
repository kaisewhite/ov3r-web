...
export const DesktopSidebar: React.FC<SidebarComponentProps> = ({ className, children, ...props }) => {
...
export const MobileSidebar: React.FC<SidebarComponentProps> = ({ className, children, ...props }) => {
